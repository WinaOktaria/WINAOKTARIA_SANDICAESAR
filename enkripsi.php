...
<body>
    <div class="container">
        ...
        <br>
        <p>Enkripsi adalah proses mengubah atau menyandikan informasi asli (plaintext) menjadi bentuk yang tidak dapat dimengerti atau sulit dimengerti, yang disebut ciphertext</p>
        <form action="<?php echo ($formAction === 'enkripsi') ? 'enkripsi.php' : 'dekripsi.php'; ?>" method="post" class="cipher-form">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            echo '<div class="result-heading">' . ucfirst($formAction) . ' Hasil :</div>';
